    ...
    <div class="wrapper">
     ...
     <div class="box box-default">
            ...
            <td width="50" align="center">
              ...
              <h1><?php echo $value->nama_agen?></h1><br><h2><u>Form Manifest</u></h2></td>
            <td width="25" align="center"><img src="<?php echo base_url('assets');?>/images/'Dharma_Jala_Prajatama'.jpg" width="100%"></td>
            </tr>
            </table>

            <a href="<?php echo site_url('manifest/cetak/'.$value->id_manifest);?>" class="btn bg-navy"><i class="fa  fa-file-pdf-o"></i>Ekspor PDF</a>
            <br>
                        <br>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea required="" class="form-control" rows="5" id="message" placeholder="Enter Notification Message" name="message" name="hide" style="display: none;" >Form Manifest Telah Di Verifikasi</textarea>
            </div>
