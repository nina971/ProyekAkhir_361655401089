    ...
    <div class="wrapper">
     ...
     <div class="box box-active">
            ...
            <td width="50" align="center">
               <?php if(isset($pernyataan_pengikatan)) {
                    foreach ($pernyataan_pengikatan as $value) { 

                    }
                } ?>
              <h1><?php echo $value->nama_agen?></h1><br><h2><u>Form Pernyataan Pengikatan</u></h2></td>
            <td width="25" align="center"><img src="<?php echo base_url('assets');?>/images/logo_transparant-01.png" width="100%"></td>
            </tr>
            </table>
             <a href="<?php echo site_url('pengikatan/cetak/'.$value->id_pengikatan);?>" class="btn bg-navy"><i class="fa  fa-file-pdf-o"></i>Ekspor PDF</a>
               <br>
                        <br>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea required="" class="form-control" rows="5" id="message" placeholder="Enter Notification Message" name="message" name="hide" style="display: none;" >Form Pengikatan Telah Di Verifikasi</textarea>
            </div>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-3"><label>Truck Sedang </label>
                 ...
                 <div class="col-xs-3"><label>Truck Besar </label>
                  <input type="text" class="form-control" value="<?php echo $value->truck_besar?>" disabled>
                </div>
                
              </div>
              <div class="row">
                <div class="col-xs-3"><label>Truck Trailler</label>
