<div class="register-box">
	...
	<div class="register-box-body">
		...
		<div class="form-group has-feedback">
			<input type="number" name="phone" class="form-control" required placeholder="Telepon">
		...
		<a href="<?php echo base_url('auth/login') ;?>" class="text-center">Saya Sudah Mempunyai Akun</a>
	</div>
</div>
