...
<body class="hold-transition skin-blue fixed sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <?php require_once('layout/_wrapperpermohonan.php') ;?>
            <!-- Main content -->
              ...
              <table id="example1" class="table table-bordered table-hover table-responsive">
                ...
                <?php
                        ...
                        <tr >
                           ...
                           <td>
                               <a href="<?php echo site_url('permohonan/get_profil/'.$key->id_permohonan_spb);?>" class="btn bg-navy"><i class="fa fa-search"></i>Lihat</a>
                           </td>
                           <td>
