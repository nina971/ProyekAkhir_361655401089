    ...
    <div class="wrapper">
     ...
     <div class="box box-danger">
            ...
            <td width="50" align="center">
              ...
              <h1 class=""><?php echo $value->nama_agen?></h1><br><h2><u>Form Muatan Kapal</u></h2></td>
            <td width="25" align="center"><img src="<?php echo base_url('assets');?>/images/'Dharma_Jala_Prajatama'.jpg" width="100%"></td>
            </tr>
            </table>
            <a href="<?php echo site_url('total/cetak/'.$value->id);?>" class="btn bg-navy"><i class="fa  fa-file-pdf-o"></i>Ekspor PDF</a>
              <br>
                        <br>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea required="" class="form-control" rows="5" id="message" placeholder="Enter Notification Message" name="message" name="hide" style="display: none;" >Form Muatan Telah Di Verifikasi</textarea>
            </div>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-3"><label>Tanggal </label>
                 ...
                 <div class="col-xs-3"><label>Truck_besar </label>
                  <input type="text" class="form-control" value="<?php echo $value->truck_besar?>" disabled>
                </div>
                
              </div>
              <div class="row">
                <div class="col-xs-3"><label>Truck Trailer</label>
                  <input type="text" class="form-control" value="<?php echo $value->truck_trailer?>" disabled>
                </div>
                 <div class="col-xs-3"><label>Truck Sedang</label>
                  <input type="text" class="form-control" value="<?php echo $value->truck_sedang?>" disabled>
                </div>
                <div class="col-xs-3"><label>Bus Besar</label>
                  <input type="text" class="form-control" value="<?php echo $value->bus_besar?>" disabled>
                </div>
                <div class="col-xs-3"><label>Bus Mini</label>
                  <input type="text" class="form-control" value="<?php echo $value->bus_mini?>" disabled>
                </div>
              ...
              <div class="row">
                 <div class="col-xs-3"><label>Kendaraan keluarga</label>
                  <input type="text" class="form-control" value="<?php echo $value->kendaraan_keluarga?>" disabled>
                </div>
                <div class="col-xs-3"><label>Sepeda Motor</label>
                  <input type="text" class="form-control" value="<?php echo $value->sepeda_motor?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah Muatan</label>
                   <!-- <?php if(isset($jumlah_muatan)) {
                    foreach ($jumlah_muatan as $data) {
