...
<body class="hold-transition skin-blue fixed sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <div class="box ">
            <div class="box-header">
                <table width="100%">
            <tr>
            <td width="25" align="center"><h3>Laporan Muatan </h3>
              <br>
              <h4>Jumlah Muatan Pada Kapal Setiap Bulan</h4>
            </td>
      ...
      <br>
       ...
       <div class="col-md-4">
      <?php echo form_open('laporanrekap/grafikmuatan'); ?>
     ...
     <?php echo form_close(); ?>
      ...
      //  // the chart.
      //    data: <?php echo $data_kendaraan ?>,
      //     xkey: 'month_name',
      //     ykeys: ['total'],
      //     labels: ['Jumlah Muatan ']
      // });
