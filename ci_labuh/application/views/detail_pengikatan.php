...
<body class="hold-transition skin-blue fixed sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <?php require_once('layout/_wrapperikat.php') ;?>
            <!-- Main content -->
             <section class="content">
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Pengikatan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
              ...
              <table id="example1" class="table table-bordered table-hover table-responsive">
                ...
                <?php
                        ...
                        <tr >
                           ...
                           <td>
                               <a href="<?php echo site_url('pengikatan/get_profil/'.$key->id_pengikatan);?>" class="btn bg-navy"><i class="fa fa-search"></i>Lihat</a>
                           </td>
                           <td>
