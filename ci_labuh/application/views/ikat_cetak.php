...
<html>
<head>
	<title>Pernyataan Pengikatan</title>
...
<?php if(isset($pengikatan)) {
          
                    foreach ($pengikatan as $value) {
...
<br><h2 align="center"><u>FORM Pernyataan Pengikatan</u></h2>
			<table align="center">
				<tbody>
					<tr>
                    ...
                    <tr>
                        <td>Banyaknya Truck Besar: <?php echo $value->truck_besar ?></td>
                        <td>Banyaknya Truck Sedang : <?php echo $value->truck_sedang ?></td>
                    </tr>

                    <tr>
                         <td>Banyaknya Truck Trailer: <?php echo $value->truck_trailer ?></td>
                         <td>Banyaknya Bus Besar : <?php echo $value->bus_besar ?></td>
                     </tr>
                     <tr>
                        <td>Banyaknya Bus Mini : <?php echo $value->bus_mini ?></td>
                      </tr>
