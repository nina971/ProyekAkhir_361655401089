    ...
    <div class="wrapper">
     ...
     <div class="box box-default">
            ...
            <td width="50" align="center">
               <?php if(isset($periksa_pemenuhan_kewajiban_kapal)) {
                    foreach ($periksa_pemenuhan_kewajiban_kapal as $value) { 

                    }
                } ?>
              <h1><?php echo $value->nama_agen?></h1><br><h2><u>Form Pemenuhan Kewajiban Kapal</u></h2></td>
            <td width="25" align="center"><img src="<?php echo base_url('assets');?>/images/logo_transparant-01.png" width="100%"></td>
              ...
              <?php if(isset($periksa_pemenuhan_kewajiban_kapal)) {
                    foreach ($periksa_pemenuhan_kewajiban_kapal as $value) { 
                        ...
                        <a href="<?php echo site_url('kewajiban/cetak/'.$value->id_pemenuhan_kewajiban);?>" class="btn bg-navy"><i class="fa  fa-file-pdf-o"></i>Ekspor PDF</a>
                          <br>
                        <br>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea required="" class="form-control" rows="5" id="message" placeholder="Enter Notification Message" name="message" name="hide" style="display: none;" >Form Pemenuhan Kewajiban Telah Di Verifikasi</textarea>
            </div>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-3"><label>Jasa Labuh </label>
                  <input type="text" class="form-control" value="<?php echo $value->jasa_labuh?>" disabled>
                </div>
                 <div class="col-xs-3"><label>Jasa Tambat </label>
                  <input type="text" class="form-control" value="<?php echo $value->jasa_tambat?>" disabled>
                </div>
                
              </div>
              <div class="row">
                <div class="col-xs-3"><label>Jasa Kenavigasian</label>
                  <input type="text" class="form-control" value="<?php echo $value->jasa_kenavigasian?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jasa Perkapalan</label>
                  <input type="text" class="form-control" value="<?php echo $value->jasa_perkapalan?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jasa Kebersihan Kapal</label>
                  <input type="text" class="form-control" value="<?php echo $value->jasa_kebersihan_kapal?>" disabled>
                </div>
