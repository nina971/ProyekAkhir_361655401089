    ...
    <div class="wrapper">
     ...
     <div class="box box-primary">
            ...
            <td width="50" align="center">
               <?php if(isset($pernyataan_nahkoda)) {
                    foreach ($pernyataan_nahkoda as $value) { 

                    }
                } ?>
              <font face="Times New Roman" color="black" ><h1 ><?php echo $value->nama_agen?></h1><br><u><h2>FORM PERNYATAAN NAHKODA</u></h2></font></td>
            <td width="25" align="center"><img src="<?php echo base_url('assets');?>/images/'Dharma_Jala_Prajatama'.jpg" width="100%"></td>
              ...
              <?php if(isset($pernyataan_nahkoda)) {
                    foreach ($pernyataan_nahkoda as $value) { 
                        ...
                        <a href="<?php echo site_url('nahkoda/cetak/'.$value->id_pernyataan_nahkoda);?>" class="btn bg-navy"><i class="fa  fa-file-pdf-o"></i>Ekspor PDF</a>
                          <br>
                        <br>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea required="" class="form-control" rows="5" id="message" placeholder="Enter Notification Message" name="message" name="hide" style="display: none;" >Form Pernyataan Nahkoda Telah Di Verifikasi</textarea>
            </div>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-3"><label>Jumlah Muatan </label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_muatan?>" disabled>
                </div>
                 <div class="col-xs-3"><label>Jumlah Penumpang </label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_penumpang?>" disabled>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-3"><label>Stabilitas Kapal Tolak</label>
                  <input type="text" class="form-control" value="<?php echo $value->stabilitas_kapal?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah Perwira Dek</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_perwiradek?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah Perwira Mesin</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_perwiramesin?>" disabled>
                </div>
               ...
               <div class="row">
                ...
                <div class="col-xs-3"><label>Jumlah ABK Lainnya</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_abklainnya?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah Alat Navigasi</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_alatnavigasi?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah Alat Penolong</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_alatpenolong?>" disabled>
                </div>
               ...
               <div class="row">
                <div class="col-xs-3"><label>Jumlah Alat Pemadam Kebakaran</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_alatpemadam?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah Alat Pencegahan Pencemaran</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_alatpencegahan?>" disabled>
                </div>
              <!--   <div class="col-xs-3"><label>Nama Jurumudi</label>
