    ...
    <div class="wrapper">
     ...
     <div class="box box-success">
            ...
            <td width="50" align="center">
              ...
              <h1><?php echo $value->nama_agen?></h1><br><h2><u>Form Permohonan Surat Persetujuan Berlayar</u></h2></td>
            <td width="25" align="center"><img src="<?php echo base_url('assets');?>/images/'Dharma_Jala_Prajatama'.jpg" width="100%"></td>
              ...
              <?php if(isset($permohonan)) {
                    foreach ($permohonan as $value) { 
                        ...
                        <a href="<?php echo site_url('permohonan/cetak/'.$value->id_permohonan_spb);?>" class="btn bg-navy"><i class="fa  fa-file-pdf-o"></i>Ekspor PDF</a>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea required="" class="form-control" rows="5" id="message" placeholder="Enter Notification Message" name="message" name="hide" style="display: none;" >Form Permohonan SPB Telah Di Verifikasi</textarea>
            </div>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-xs-3"><label>Tempat Permohonan </label>
                  <input type="text" class="form-control" value="<?php echo $value->tempat_permohonan?>" disabled>
                </div>
                 <div class="col-xs-3"><label>Tanggal </label>
                  <input type="text" class="form-control" value="<?php echo $value->tanggal_permohonan?>" disabled>
                </div>
                
              </div>
              <div class="row">
                <div class="col-xs-3"><label>Jam</label>
                  <input type="text" class="form-control" value="<?php echo $value->waktu_permohonan?>" disabled>
                </div>
                <div class="col-xs-3"><label>Jumlah ABK</label>
                  <input type="text" class="form-control" value="<?php echo $value->jumlah_awak?>" disabled>
                </div>
                ...
                <div class="col-xs-3"><label>Pelabuhan Tujuan</label>
                  <input type="text" class="form-control" value="<?php echo $value->pelabuhan_tujuan?>" disabled>
                </div>
